<template>
  <div class="subsystem-container">
    ...
    <div class="content-area">
      ...
      <!-- 组件列表抽屉 -->
      <a-drawer
        v-model:visible="componentDrawer.visible"
      ...
      <!-- 子系统表单弹窗 -->
      <a-modal
        v-model:visible="subsystemModal.visible"
      ...
      <!-- 组件表单弹窗 -->
      <a-modal
        v-model:visible="componentModal.visible"
