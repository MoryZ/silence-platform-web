const local = {
  ...
  page: {
    ...
    about: {
      title: '关于',
      introduction: `<span style="font-weight: bold; color: #1677ff">Snail Job</span>
 <br />
