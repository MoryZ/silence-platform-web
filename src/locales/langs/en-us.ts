  ...
  page: {
    ...
    notifyRecipient: {
      ...
      form: {
        ...
        notifyType: 'Please select notification type',
        ats: 'Please enter notification recipient',
        ...
        tos: 'Please enter recipient email address',
    ...
    retry: {
      ...
      generateIdempotentId: 'Generate Idempotent ID',
      generateIdempotentIdTooltip: 'Generated by client',
      retryStatusType: {
        retrying: 'Retrying',
        finished: 'Finished',
        maxRetry: 'Maximum retry count reached',
